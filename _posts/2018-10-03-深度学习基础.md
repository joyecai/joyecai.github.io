...
本文原作者是来自哈工大（深圳）的HUA Yang同学，个人表示感谢！
...
**标量形式**：
[![](../_assets/公式_20180705190236.png)](http://www.codecogs.com/eqnedit.php)

[![](../_assets/公式_20180705134851.png)](http://www.codecogs.com/eqnedit.php?latex=\begin{aligned}&space;\frac{\partial&space;C}{\partial&space;a_j^{(l)}}}={\color{Teal}\sum_{k=0}^{n_l-1}}&space;\frac{\partial&space;z_k^{(l&plus;1)}}{\partial&space;a_j^{(l)}}}&space;\frac{{\color{Blue}&space;\partial&space;a_k^{(l&plus;1)}}}{\partial&space;z_k^{(l&plus;1)}}&space;\frac{\partial&space;C}{&space;\partial&space;a_k^{(l&plus;1)}}}&space;\end{aligned})

[![](../_assets/公式_20180705154543.png)](http://www.codecogs.com/eqnedit.php?latex=\begin{aligned}&space;\frac{\partial&space;C}{\partial&space;w_{j,k}^{(l)}}}=\frac{\partial&space;z_j^{(l)}}{\partial&space;w_{j,k}^{(l)}}}\frac{\partial&space;a_j^{(l)}}}{\partial&space;z_j^{(l)}}\frac{\partial&space;C}{\partial&space;a_j^{(l)}}}&space;\end{aligned})

[![](../_assets/公式_20180705154650.png)](http://www.codecogs.com/eqnedit.php?latex=\begin{aligned}&space;\frac{\partial&space;C}{\partial&space;b_{j}^{(l)}}}=\frac{\partial&space;z_j^{(l)}}{\partial&space;b_{j}^{(l)}}}\frac{\partial&space;a_j^{(l)}}}{\partial&space;z_j^{(l)}}\frac{\partial&space;C}{\partial&space;a_j^{(l)}}}&space;\end{aligned})
...
![5](../_assets/TIM截图20180704193955.png)

- 以 **均方误差（MSE）** 损失函数为例，有

![6](../_assets/公式_20180705190536.png)

- Nielsen 的课程中提供了另一种更利于计算的表述，本质上是一样的。

![7](../_assets/TIM截图20180705162841.png)
