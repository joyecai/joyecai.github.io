...
以下大部分内容来自哈工大（深圳）的HUA Yang同学，非常感谢！Yang同学，非常感谢！
...
**标量形式**：
![1](https://github.com/ColaDrill/Algorithm_Interview_Notes-Chinese/raw/master/_assets/%E5%85%AC%E5%BC%8F_20180705190236.png)
![2](https://github.com/ColaDrill/Algorithm_Interview_Notes-Chinese/raw/master/_assets/%E5%85%AC%E5%BC%8F_20180705134851.png)
![3](https://github.com/ColaDrill/Algorithm_Interview_Notes-Chinese/raw/master/_assets/%E5%85%AC%E5%BC%8F_20180705154543.png)
![4](https://github.com/ColaDrill/Algorithm_Interview_Notes-Chinese/raw/master/_assets/%E5%85%AC%E5%BC%8F_20180705154650.png)
...
![5](https://github.com/ColaDrill/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM%E6%88%AA%E5%9B%BE20180704193955.png)

- 以 **均方误差（MSE）** 损失函数为例，有
![6](https://github.com/ColaDrill/Algorithm_Interview_Notes-Chinese/raw/master/_assets/%E5%85%AC%E5%BC%8F_20180705190536.png)

- Nielsen 的课程中提供了另一种更利于计算的表述，本质上是一样的。
![7](https://github.com/ColaDrill/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM%E6%88%AA%E5%9B%BE20180705162841.png)
...
1.整流线性单元 `ReLU`
- ReLU 通常是激活函数较好的默认选择
![8](https://github.com/ColaDrill/Algorithm_Interview_Notes-Chinese/raw/master/_assets/%E5%85%AC%E5%BC%8F_20180610213451.png)
![9](https://github.com/ColaDrill/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM%E6%88%AA%E5%9B%BE20180608212808.png)

2.`ReLU` 的拓展
- `ReLU` 及其扩展都基于以下公式：
![10](https://github.com/ColaDrill/Algorithm_Interview_Notes-Chinese/raw/master/_assets/%E5%85%AC%E5%BC%8F_20180610214123.png)
...
![11](https://github.com/ColaDrill/Algorithm_Interview_Notes-Chinese/raw/master/_assets/%E5%85%AC%E5%BC%8F_20180610214846.png)
![12](https://github.com/ColaDrill/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM%E6%88%AA%E5%9B%BE20180608195851.png)
...
![13](https://github.com/ColaDrill/Algorithm_Interview_Notes-Chinese/raw/master/_assets/%E5%85%AC%E5%BC%8F_20180610215150.png)
> 在神经网络中很少使用 RBF 作为激活函数，因为它对大部分 x 都饱和到 0，所以很难优化。

- **softplus**：
`softplus` 是 `ReLU` 的平滑版本。
![14](https://github.com/ColaDrill/Algorithm_Interview_Notes-Chinese/raw/master/_assets/%E5%85%AC%E5%BC%8F_20180610215222.png)
![15](https://github.com/ColaDrill/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM%E6%88%AA%E5%9B%BE20180608204913.png)
> 通常不鼓励使用 softplus 函数，大家可能希望它具有优于整流线性单元的性质，但根据经验来看，它并没有。
> (Glorot et al., 2011a) 比较了这两者，发现 ReLU 的结果更好。

- **硬双曲正切函数（hard tanh）**：
![16](https://github.com/ColaDrill/Algorithm_Interview_Notes-Chinese/raw/master/_assets/%E5%85%AC%E5%BC%8F_20180610215308.png)
...
![17](https://github.com/ColaDrill/Algorithm_Interview_Notes-Chinese/raw/master/_assets/%E5%85%AC%E5%BC%8F_20180831165546.png)

- BN 可以看作在各层之间加入了一个新的计算层，**对数据分布进行额外的约束**，从而增强模型的泛化能力；
- 但同时 BN 也降低了模型的拟合能力，破坏了之前学到的**特征分布**；
- 为了**恢复数据的原始分布**，BN 引入了一个**重构变换**来还原最优的输入数据分布
![18](https://github.com/ColaDrill/Algorithm_Interview_Notes-Chinese/raw/master/_assets/%E5%85%AC%E5%BC%8F_20180831165516.png)
  其中 `γ` 和 `β` 为可训练参数。

**小结**
- 以上过程可归纳为一个 **`BN(x)` 函数**：
![19](https://github.com/ColaDrill/Algorithm_Interview_Notes-Chinese/raw/master/_assets/%E5%85%AC%E5%BC%8F_20180903223427.png)

其中
![20](https://github.com/ColaDrill/Algorithm_Interview_Notes-Chinese/raw/master/_assets/%E5%85%AC%E5%BC%8F_20180903224323.png)

- **完整算法**：
![21](https://github.com/ColaDrill/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM%E6%88%AA%E5%9B%BE20180903222433.png)
...
- 当**测试**或**预测时**，每次可能只会传入**单个数据**，此时模型会使用**全局统计量**代替批统计量；
    ...
    - 具体计算公式为：
    ![22](https://github.com/ColaDrill/Algorithm_Interview_Notes-Chinese/raw/master/_assets/%E5%85%AC%E5%BC%8F_20180903220828.png)
    > 其中 `μ_i` 和 `σ_i` 分别表示第 i 轮 batch 保存的均值和标准差；`m` 为 batch_size，系数 `m/(m-1)` 用于计算**无偏方差估计**
    >> 原文称该方法为**移动平均**（moving averages）

- 此时，`BN(x)` 调整为：
![23](https://github.com/ColaDrill/Algorithm_Interview_Notes-Chinese/raw/master/_assets/%E5%85%AC%E5%BC%8F_20180903224557.png)

- **完整算法**：
![24](https://github.com/ColaDrill/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM%E6%88%AA%E5%9B%BE20180903224842.png)
...
<div style="float:left;border:solid 1px 000;margin:2px;"><img src="https://github.com/ColaDrill/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM%E6%88%AA%E5%9B%BE20180608171710.png"></div>
<div style="float:left;border:solid 1px 000;margin:2px;"><img src="https://github.com/ColaDrill/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM%E6%88%AA%E5%9B%BE20180608172312.png"></div>
...
![26](https://github.com/ColaDrill/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM%E6%88%AA%E5%9B%BE20180611152559.png)
...
- [ICML 2013](https://cs.nyu.edu/~wanli/dropc/dropc.pdf)

Dropout：完全随机扔
- [JMLR 2014](http://jmlr.org/papers/volume15/srivastava14a.old/srivastava14a.pdf)

SpatialDropout：按channel随机扔
- [CVPR 2015](http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.858.5872&rep=rep1&type=pdf)

Stochastic Depth：按res block随机扔
- [ECCV 2016](https://arxiv.org/pdf/1603.09382.pdf)

Cutout：在input层按spatial块随机扔
- [CoRR 2017](https://arxiv.org/pdf/1708.04552.pdf)

DropBlock：每个feature map上按spatial块随机扔
- [NIPS 2018](https://arxiv.org/pdf/1810.12890.pdf)
