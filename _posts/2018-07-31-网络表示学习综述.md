...
本文是对THU的Peng Cui所撰[《A Survey on Network Embedding》](https://arxiv.org/abs/1711.08752)一文的笔记，作梳理用。（在此特别感谢舍友@YU对原文的翻译工作！）
...
#### 网络结构和属性保留的网络嵌入方法(network structure and properties preserving network embedding)
...
#### 带有辅助信息的网络嵌入方法(network embedding with side information)
...
#### 高级信息保留的网络嵌入方法(advanced information preserving network embedding)
