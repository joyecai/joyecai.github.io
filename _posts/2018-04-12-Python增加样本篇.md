...
本篇是特征工程和模型之外的技巧篇，方法是增加新样本，即利用半监督代替过采样。（[>>原文链接](https://github.com/wepe/DataCastle-Solution/tree/master/code/M5)）

### 迭代半监督
- 利用最好的模型预测无标签数据，调整阈值 a，b 将样本添加到训练集，其中 01 样本比例为 5：1~9：1。如果线上有提高，将这部分样本添加到训练集继续训练融合来预测无标签数据，重复迭代。
![bjd](https://upload-images.jianshu.io/upload_images/13187322-648d7c7c07b6f155.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/398/format/webp)
...
![baoli](https://upload-images.jianshu.io/upload_images/13187322-db29baa3be7ebd3c.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/418/format/webp)
