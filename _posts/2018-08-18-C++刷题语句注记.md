...
[二分法](http://www.voidcn.com/article/p-mlwbzguh-bke.html): 已有顺序的查找问题

数	组：[ij前后指针](https://leetcode-cn.com/problems/remove-duplicates-from-sorted-array/solution/)、下标对应存count

[链	表](https://blog.csdn.net/zqxnum1/article/details/48156913)：快慢指针、三指针、[递归](https://leetcode.com/problems/swap-nodes-in-pairs/discuss/167536/Simple-C++-Recursive:-Beats-100)

[二叉树](https://www.jianshu.com/p/35b07dbcdf73)：递归遍历、非递归遍历(stack)、DFS、层次遍历(queue)、[卡特兰数(二叉查找树个数)](https://blog.csdn.net/qqxx6661/article/details/76285972)
...
nth_element(L,kth,R);     //使得[L,kth)的元素都比kth小，(kth,R)的元素都比kth大
```
