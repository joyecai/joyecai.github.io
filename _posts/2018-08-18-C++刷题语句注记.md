...
数	组：[ij前后指针](https://leetcode-cn.com/problems/remove-duplicates-from-sorted-array/solution/)、下标对应存计数、[给元素值赋正负来表达额外信息](https://www.polarxiong.com/archives/LeetCode-448-find-all-numbers-disappeared-in-an-array.html)
