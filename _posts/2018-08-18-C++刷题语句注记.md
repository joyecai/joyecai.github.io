...
数	组：[ij前后指针](https://leetcode-cn.com/problems/remove-duplicates-from-sorted-array/solution/)、下标对应存count

[链	表](https://blog.csdn.net/zqxnum1/article/details/48156913)：[快慢指针](https://leetcode-cn.com/submissions/detail/7434548/)、三指针、[递归](https://leetcode.com/problems/swap-nodes-in-pairs/discuss/167536/Simple-C++-Recursive:-Beats-100)
> - 指针p每次赋值后，草稿纸列出一下p后面的串；如果串的最前面已符合题目要求，则前进：p = p->next
...
str2 = str1.substr(pos,n);                 //返回子串 [pos, pos+n)，即从pos开始的n个字符，包含pos的字符
